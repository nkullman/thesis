...
\section{Methods}
\label{sec:methods}
We lay a foundation for quantitative conflict analysis of objective functions in multi-objective systems. The analysis centers on the use of three metrics: two existing measures from EMO and one that we have developed and introduce for the first time here. Two case studies on the in forest management serve to illustrate the conflict analysis. Prior to describing the case studies, we first define terminology and describe each of the measures used in our analysis.
