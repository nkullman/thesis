...
\end{align}
Given two frontiers $Z^1$ and $Z^2$, how do you interpret unequal hypervolumes? Consider Figure INSERTFIGURE which shows the relative objective space for a two-dimensional frontier.
Since the hypervolume indicator of t using Then we can define the \textit{binary hypervolume indicator} of two frontiers $Z^1$ and $Z^2$ as \cite{zitzler1999evolutionary}
\begin{align}
