...
\end{align}
The $i$th component of an objective vector $\mathbf{z}$ represents the achievement in objective $i$ by the corresponding decision vector $\mathbf{x}$.
...
\end{align}
The $i$th component of $\mathbf{\tau}^{1,2}$ represents the amount of objective $i$ that would be sacrificed or gained by selecting $\mathbf{z}^2$ instead of $\mathbf{z}^1$.
