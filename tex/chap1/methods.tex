...
After determining that objectives conflict with one another, one may wish to determine the severity of the conflict. HYPERVOL HERE.

\subsection{A new measure of conflict}Consider the frontiers in Figure \ref{fig:ConflictVariesExample}. The conflict between maximization objectives $i$ and $j$ is greatest in Frontier C and least in Frontier A.
\begin{figure}[ht]
\centering
