...
It is currently unknown how climate change will alter the tradeoff relationships among bundled ecosystem services. This drives uncertainty in whether and how forest planners have to change their compromise strategies to maintain a desired balance among ecosystem services. In this section, I describe a case study in the Deschutes National Forest to quantify the changes in tradeoff relationships and how understanding these changes may result in better management decisions. To quantify the changes in the tradeoff relationships, I employ multi-objective mathematical optimization and compare the results under three different climate change scenarios.
