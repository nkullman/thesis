...
The Drink Planning Area is a 7056 ha area on the east slopes of the Cascade Mountain Range in the Deschutes National Forest (see Figure \ref{fig:drinkOverview}). Like many forests, the Drink is managed for the simultaneous provision of multiple ecosystem services.  These ecosystem services were determined through a process involving stakeholder meetings and discussions regarding compatible ecosystem services. For this study, a subset of the chosen ecosystem services was selected for study. While the USFS manages for many services simultaneously, many of the services are ``stacked'' rather than bundled, meaning that the ecosystem services are not in conflict - that is, maximizing the provision of one ecosystem service simultaneously maximizes another. Stacked ecosystem services need not all be studied with multi-objective optimization, since the selection and maximization of one ecosystem service entails the maximization of all of them in the stack. For that reason, we disregard non-conflicting ecosystem services and select a minimal bundle for which to employ multi-objective optimization. The minimal bundle selected for the case study in this work is a set of three ecosystem services. The Forest Service seeks to ensure sustained provision of each these ecosystem services into the future, and this may require an understanding of how these ecosystem services are impacted - jointly and independently - by climate change.
