...
\subsection{A new measure of pairwise conflict}Consider the frontiers in Figure \ref{fig:ConflictVariesExample}. The conflict between maximization objectives $i$ and $j$ is greatest in Frontier C and least in Frontier A.
\begin{figure}[ht]
\centering
...
\subsection{Frontier-level conflict metrics}
