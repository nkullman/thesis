...
Finally, we also observe a decrease in the provision of NSO habitat under the consideration of climate change. We see in Table \ref{tab:nsoHabDQs} the number of instances in which performing a fuel removal that fuel removals more frequently disqualify a stand from being NSO habitat under the climate change scenarios than for None.
