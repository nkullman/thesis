...
Next, we consider how climate change impacts the joint provision of ecosystem services and the conflict among them. Our results show that climate change tends to increase overall system conflict and also has an impact on the joint provision of ecosystem services.

We observe a decreasing hypervolume with increasing severity of climate change - see Table \ref{tab:hypervols}. A decreasing hypervolume is indicative of more conflict in the system, meaning that climate change is associated with more conflict among the ecosystem services.
